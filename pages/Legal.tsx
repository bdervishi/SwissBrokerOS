    ...
    const renderContent = () => {
        switch (type) {
                    ...
                    <>
                        ...
                        <section className="space-y-6 text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                            <div>
                                ...
                                <p>SwissBroker OS<br />Fintech Switzerland AG<br />Bahnhofstrasse 1<br />8001 Zürich<br />Schweiz</p>
                            </div>
                            <div>
                                <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Handelsregister</h2>
                                <p>Eingetragener Firmenname: Fintech Switzerland AG<br />Nummer: CHE-123.456.789<br />Handelsregisteramt: Kanton Zürich</p>
                            </div>
                            <div>
                                <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Kontakt</h2>
                                <p>E-Mail: support@swissbroker-os.ch<br />Webseite: www.swissbroker-os.ch</p>
                            </div>
                        </section>
                    </>
                );
                    ...
                    <>
                        ...
                        <section className="space-y-8 text-slate-600 dark:text-slate-400 leading-relaxed text-sm font-medium">
                            ...
                            <div>
                                ...
                                <p>Diese AGB gelten für alle Dienstleistungen der Fintech Switzerland AG im Zusammenhang mit dem Produkt SwissBroker OS.</p>
                            </div>
                            <div>
            ...
            case 'sitemap':
                return (
                    <>
                        <h1 className="text-4xl font-extrabold mb-8 text-slate-900 dark:text-white tracking-tight">Sitemap</h1>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            <div>
                                <h2 className="text-xl font-bold text-brand-600 mb-4 uppercase tracking-wider text-sm">Öffentliche Seiten</h2>
                                <ul className="space-y-3 text-slate-600 dark:text-slate-400 font-medium">
                                    <li><Link to="/" className="hover:text-brand-600 dark:hover:text-white transition-colors">Startseite</Link></li>
                                    <li><Link to="/features/crm" className="hover:text-brand-600 dark:hover:text-white transition-colors">CRM für Makler</Link></li>
                                    <li><Link to="/features/ai-risk" className="hover:text-brand-600 dark:hover:text-white transition-colors">KI-Risikoanalyse</Link></li>
                                    <li><Link to="/features/mortgage-calc" className="hover:text-brand-600 dark:hover:text-white transition-colors">Hypothekenrechner</Link></li>
                                    <li><Link to="/features/tax-module" className="hover:text-brand-600 dark:hover:text-white transition-colors">Steuermodul</Link></li>
                                    <li><Link to="/features/client-portal" className="hover:text-brand-600 dark:hover:text-white transition-colors">Kundenportal (App)</Link></li>
                                </ul>
                            </div>
                            <div>
                                <h2 className="text-xl font-bold text-slate-500 mb-4 uppercase tracking-wider text-sm">Rechtliches</h2>
                                <ul className="space-y-3 text-slate-600 dark:text-slate-400 font-medium">
                                    <li><Link to="/legal/imprint" className="hover:text-brand-600 dark:hover:text-white transition-colors">Impressum</Link></li>
                                    <li><Link to="/legal/privacy" className="hover:text-brand-600 dark:hover:text-white transition-colors">Datenschutz</Link></li>
                                    <li><Link to="/legal/terms" className="hover:text-brand-600 dark:hover:text-white transition-colors">AGB</Link></li>
                                </ul>
                            </div>
                        </div>
                    </>
