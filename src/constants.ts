...
export const MOCK_CLIENTS: Client[] = [
  ...
  // NEW CORPORATE CLIENT MOCKS
  {
    id: 'c_corp_1',
    type: 'CORPORATE',
    username: 'tech_innovations',
    email: 'info@tech-innovations.ch',
    firstName: 'Sarah', // Contact Person
    lastName: 'Tech', // Contact Person
    companyName: 'Tech Innovations AG',
    uidNumber: 'CHE-101.202.303',
    nogaCode: '620100', // IT Services
    employeeCount: 45,
    totalPayrollSum: 4500000,
    role: UserRole.CLIENT,
    address: 'Technoparkstrasse 1',
    zipCity: '8005 Zürich',
    advisorId: 'u_broker_1',
    taxDomicile: 'Zürich',
    avatarUrl: 'https://ui-avatars.com/api/?name=Tech+Innovations&background=0D8ABC&color=fff',
    tenantId: 't1',
    trustScore: {
        score: 98,
        level: 'HIGH',
        ...
        checks: [
            { id: 'kc1', checkName: 'Handelsregister (Zefix)', status: 'PASSED', lastChecked: '2024-06-05', details: 'Aktiv, letzte Mutation: 2023' },
            { id: 'kc2', checkName: 'Betreibungsregister', status: 'PASSED', lastChecked: '2024-05-01' }
        ]
    }
  },
  {
    ...
    type: 'CORPORATE',
    username: 'muster_bau',
    email: 'buero@musterbau.ch',
    firstName: 'Thomas',
    lastName: 'Baumeister',
    companyName: 'Muster Bau GmbH',
    uidNumber: 'CHE-999.888.777',
    nogaCode: '412000', // Bau
    employeeCount: 12,
    totalPayrollSum: 950000,
    role: UserRole.CLIENT,
    address: 'Industriestrasse 10',
    zipCity: '8952 Schlieren',
    advisorId: 'u_broker_1',
    taxDomicile: 'Zürich',
    avatarUrl: 'https://ui-avatars.com/api/?name=Muster+Bau&background=A16207&color=fff',
    tenantId: 't1',
    trustScore: {
        score: 85,
        level: 'MEDIUM',
        lastUpdated: '2024-06-01',
        checks: [
            { id: 'kc3', checkName: 'Bonität', status: 'WARNING', lastChecked: '2024-06-01', details: 'Mittelmässiges Rating.' }
        ]
    }
  }
];
...
export const MOCK_POLICIES: Policy[] = [
  ...
  // CORPORATE POLICIES
  {
    ...
    clientId: 'c_corp_1',
    insurer: 'Swiss Life',
    type: 'BVG (Pensionskasse)',
    policyNumber: 'BVG-999-001',
    startDate: '01.01.2024',
    endDate: '31.12.2026',
    premiumAmount: 45000.00, // Annual Volume
    premiumFrequency: 'Jährlich',
    status: PolicyStatus.ACTIVE,
    cancellationNoticePeriod: 6,
    coverageDetails: ['Vollversicherung', 'Kaderplan 1e'],
    initialCommission: 2500,
    liabilityDurationMonths: 36,
    marketBenchmarkDelta: -5,
    contractFlags: []
  },
  {
    id: 'p_corp_2',
    ...
    cancellationNoticePeriod: 3,
    deductible: 500,
    coverageDetails: ['Betriebshaftpflicht', 'IT-Dienstleister Deckung'],
    initialCommission: 200,
    liabilityDurationMonths: 0,
    marketBenchmarkDelta: 0,
    contractFlags: []
  },
  {
    ...
    insurer: 'Suva',
    type: 'UVG (Unfall)',
    policyNumber: 'UVG-888',
    startDate: '01.01.2024',
    endDate: '31.12.2024',
    premiumAmount: 15600.00,
    premiumFrequency: 'Vierteljährlich',
    status: PolicyStatus.ACTIVE,
    cancellationNoticePeriod: 3,
    coverageDetails: ['BU', 'NBU'],
    initialCommission: 0, // SUVA pays no commission usually, but tracking is important
    liabilityDurationMonths: 0,
    marketBenchmarkDelta: 0,
    contractFlags: []
  }
...
export const MOCK_TENANTS: Tenant[] = [
    ...
    { 
        ...
        activeAddons: ['addon_website', 'addon_corporate_suite'],
...
export const MOCK_ADDONS: SaaSAddon[] = [
    ...
    { id: 'addon_corporate_suite', name: 'Corporate Broker Suite', description: 'B2B Modul für Firmenkunden, Flotten & BVG-Verwaltung. Inklusive Zefix-Anbindung.', price: 89, iconName: 'Building2' }, 
];
...
export const MOCK_SAAS_PACKAGES: SaaSPackage[] = [
    ...
    { id: 'pkg_enterprise', name: 'Enterprise', description: 'Für Organisationen', price: 899, billingCycle: 'MONTHLY', features: ['Alles in Pro', 'Corporate Suite (B2B CRM)', 'API Zugriff', 'SLA', 'Custom Domain', 'Arbeitsrapport & HR'], maxUsers: 25, supportLevel: '24/7 Phone', includedAddons: ['addon_branding', 'addon_corporate_suite'] },
];
