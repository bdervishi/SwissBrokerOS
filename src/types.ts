...
/* Fix: Added missing Client interface with Corporate extensions */
export interface Client {
    ...
    companyName?: string; // NEW: Required for CORPORATE
    uidNumber?: string; // NEW: CHE-123.456.789
    nogaCode?: string; // NEW: Industry Code
    employeeCount?: number; // NEW
    totalPayrollSum?: number; // NEW: Lohnsumme for BVG
    role: UserRole;
    avatarUrl: string;
    tenantId: string;
    address: string;
