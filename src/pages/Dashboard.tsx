    ...
    <Layout>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8 min-w-0">
          <Card title={role === UserRole.BROKER_MARKETING ? "Lead Generierung" : "Abschluss-Performance (YTD)"}>
...
// Layout specifically for Hunter view to handle responsive margins correctly
const InternalDashboardLayout = ({ children }: { children: React.ReactNode }) => (
